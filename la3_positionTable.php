...
<head>
    ...
    <title>Welcome to Position Table</title>
...
<body>
    ...
    <div class="content">
        <div class='add-record'>
            <button class='btn add' id='add-position'>+ Add Record</button>
        </div>
        ...
        <table border='1'>
            ...
            <?php
            $query = "SELECT position_code, position_desc FROM position ORDER BY position_code ASC";
                    ...
                    <td>
                        <div class='btn-container'>
                            <div class='btn-wrapper'>
                                <button class='edit btn' data-position_code=\"$position_code\">Edit</button>
                            </div>
                            <div class='btn-wrapper'>
                                <button class='delete btn' data-position_code=\"$position_code\" data-position_desc=\"$position_desc\">Delete</button>
                            </div>
                        </div>
                    </td>
                </tr>";
